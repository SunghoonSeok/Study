...
efficientnet = EfficientNetB4(include_top=False,weights='imagenet',input_shape=(176,176,3))
...
# predict
model.load_weights('../data/modelcheckpoint/lotte_13.h5')
...
sub.to_csv('../data/lotte2/answer (12).csv',index=False)