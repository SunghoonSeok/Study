...
file_path = 'c:/data/modelcheckpoint/lotte_efficientnetb4.hdf5'
...
model = load_model('c:/data/modelcheckpoint/lotte_efficientnetb4.hdf5')
...
submission.to_csv('c:/data/lotte/sample_efficientb4.csv', index=False)