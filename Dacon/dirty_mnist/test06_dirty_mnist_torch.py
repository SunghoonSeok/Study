...
trainset = MnistDataset('c:/data/test/dirty_mnist/dirty_mnist_clean/', 'c:/data/test/dirty_mnist/dirty_mnist_2nd_answer.csv', transforms_train)
testset = MnistDataset('c:/data/test/dirty_mnist/test_dirty_mnist_clean/', 'c:/data/test/dirty_mnist/sample_submission.csv', transforms_test)
