...
submission = pd.read_csv('c:/data/kaggle/titanic/sample_submission.csv')
test_df[TARGET] = pd.read_csv("c:/data/kaggle/titanic/pseudo_label.csv")[TARGET]
...
submission['submit_2'] = pd.read_csv("c:/data/kaggle/titanic/dae.csv")[TARGET]
submission['submit_3'] = pd.read_csv("c:/data/kaggle/titanic/pseudo_label.csv")[TARGET]
