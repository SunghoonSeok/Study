...
dense1 = Conv1D(64, 3, padding='same', activation='relu')(inputs)
dense1 = Conv1D(64, 3, activation='relu')(dense1)
...
modelpath= '../data/modelcheckpoint/k54_conv1d_boston_checkpoint.hdf5'
...
# conv1d
# loss, mae :  7.315476894378662 1.9616488218307495
# RMSE :  2.7047138753960667
# R2 :  0.9124764290261769

# modelcheckpoint....
# loss, mae :  8.327465057373047 2.1480462551116943
# RMSE :  2.8857347766369967
# R2 :  0.900368837624897

# loss, mae :  10.381305694580078 2.320072650909424
# RMSE :  3.222003277607094
# R2 :  0.8757963592533168
