...
if __name__ == '__main__':
    ...
    s1 = Sticker('c:/data/gif/iu1.gif', xy=[430, 830], size=0.7, on_top=True)
    # s1.walk(from_xy=[430, 830], to_xy=[700, 830])

    s2 = Sticker('c:/data/gif/iu2.gif', xy=[1200, 830], size=0.7, on_top=True)
    s2.walk(from_xy=[1200, 830], to_xy=[1200, 1080])
