...
search.fit(x_train, y_train, verbose=1,epochs=400,validation_split=0.2, callbacks=[es,lr,cp]) # epochs default 1
...
# 최종 스코어 : 0.8588508754166867
# {'optimizer': <class 'tensorflow.python.keras.optimizer_v2.adam.Adam'>, 'node2': 128, 'node1': 256, 'drop': 0.2, 'batch_size': 8, 'activation': 'relu'}
# -14.334723472595215