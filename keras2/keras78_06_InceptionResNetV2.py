...
file_path = 'c:/data/modelcheckpoint/checkpoint_78_6_Inceptionresnetv2.hdf5'
...
model2 = load_model('c:/data/modelcheckpoint/checkpoint_78_6_Inceptionresnetv2.hdf5')
