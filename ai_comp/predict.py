...
if __name__ == '__main__':
    ...
    test_loader = DataLoader(train_dataset, batch_size=TRAIN_BATCH_SIZE, num_workers=NUM_WORKERS, pin_memory=PIN_MEMORY, shuffle=True, drop_last=True)
    ...
    CustomTrainer.predict_epoch(dataloader=test_loader,)